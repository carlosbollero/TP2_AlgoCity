...
public class ControladorUsuariosTest {
	...
	@Test
	public void testObtenerUsuariosYaExistentes() {
		
		ControladorUsuarios controlador = new ControladorUsuarios();
		controlador.addUsuario("Jose");
		controlador.addUsuario("Martin");
		controlador.addUsuario("Fernando");
		
		assertTrue(controlador.getUsuario("Jose") == controlador.buscarUsuario("Jose"));
		assertTrue(controlador.getUsuario("Martin") == controlador.buscarUsuario("Martin"));
		assertTrue(controlador.getUsuario("Fernando") == controlador.buscarUsuario("Fernando"));
