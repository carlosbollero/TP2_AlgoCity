...
public class JuegoTest {
	 ...
	 * para agregar el pozo de agua
	 * 
	 * Point puntoDeUnAgua = mapaTerritorio.getPosicionDeUnaSuperficieDeAgua();
	 * 
	 * unJuego.agregarPozoDeAguaEn((int) puntoDeUnAgua.getX(), (int)
	 * puntoDeUnAgua.getY());
	 * 
	 * MapaEdilicio mapaEdilicio = unJuego.getMapaEdilicio();
	 * assertFalse(mapaEdilicio.estaVacio());
	 * assertTrue(mapaEdilicio.tieneCoordenadaOcupada( (int)
	 * puntoDeUnAgua.getX(), (int) puntoDeUnAgua.getY())); }
	 * 
	 * @Test public void testAgregarEstacionDeBomberosEnMapaCorrespondiente() {
	 * 
	 * Juego unJuego = new Juego(); MapaTerritorio mapaTerritorio =
	 * unJuego.getMapaTerritorio(); // Busca una coordenada con terreno valido
	 * para agregar la estacion de // bomberos Point puntoDeUnaTierra =
	 * mapaTerritorio .getPosicionDeUnaSuperficieDeTierra();
	 * 
	 * unJuego.agregarEstacionDeBomberosEn((int) puntoDeUnaTierra.getX(), (int)
	 * puntoDeUnaTierra.getY());
	 * 
	 * MapaEdilicio mapaEdilicio = unJuego.getMapaEdilicio();
	 * assertFalse(mapaEdilicio.estaVacio());
	 * assertTrue(mapaEdilicio.tieneCoordenadaOcupada( (int)
	 * puntoDeUnaTierra.getX(), (int) puntoDeUnaTierra.getY())); }
	 * 
	 * @Test public void testAgregarUnidadResidencialEnMapaCorrespondiente() {
	 * 
	 * Juego unJuego = new Juego(); MapaTerritorio mapaTerritorio =
	 * unJuego.getMapaTerritorio(); // Busca una coordenada con terreno valido
	 * para agregar la unidad // residencial Point puntoDeUnaTierra =
	 * mapaTerritorio .getPosicionDeUnaSuperficieDeTierra();
	 * 
	 * unJuego.agregarUnidadResidencialEn((int) puntoDeUnaTierra.getX(), (int)
	 * puntoDeUnaTierra.getY());
	 * 
	 * MapaEdilicio mapaEdilicio = unJuego.getMapaEdilicio();
	 * assertFalse(mapaEdilicio.estaVacio());
	 ...
	 * puntoDeUnaTierra.getX(), (int) puntoDeUnaTierra.getY())); }
	 * 
	 * @Test public void testAgregarUnidadIndustrialEnMapaCorrespondiente() {
	 * 
	 * Juego unJuego = new Juego(); MapaTerritorio mapaTerritorio =
	 * unJuego.getMapaTerritorio(); // Busca una coordenada con terreno valido
	 * para agregar la unidad // industrial Point puntoDeUnaTierra =
	 * mapaTerritorio .getPosicionDeUnaSuperficieDeTierra();
	 * 
	 * unJuego.agregarUnidadIndustrialEn((int) puntoDeUnaTierra.getX(), (int)
	 * puntoDeUnaTierra.getY());
	 * 
	 * MapaEdilicio mapaEdilicio = unJuego.getMapaEdilicio();
	 * assertFalse(mapaEdilicio.estaVacio());
	 ...
	 * puntoDeUnaTierra.getX(), (int) puntoDeUnaTierra.getY())); }
	 * 
	 * @Test public void testAgregarUnidadComercialEnMapaCorrespondiente() {
	 * 
	 * Juego unJuego = new Juego(); MapaTerritorio mapaTerritorio =
	 * unJuego.getMapaTerritorio(); // Busca una coordenada con terreno valido
	 * para agregar la unidad // comercial Point puntoDeUnaTierra =
	 * mapaTerritorio .getPosicionDeUnaSuperficieDeTierra();
	 * 
	 * unJuego.agregarUnidadComercialEn((int) puntoDeUnaTierra.getX(), (int)
	 * puntoDeUnaTierra.getY());
	 * 
	 * MapaEdilicio mapaEdilicio = unJuego.getMapaEdilicio();
	 * assertFalse(mapaEdilicio.estaVacio());
