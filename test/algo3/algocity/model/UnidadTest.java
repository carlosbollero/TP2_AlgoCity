...
public class UnidadTest {
	...
	public void testUnidadComercialTieneConsumoValido() {
		...
		Edificador unEdificador = new Edificador();
		UnidadComercial unaUnidadComercial = unEdificador.construirUnidadComercial();
	...
	public void testEstacionDeBomberosTieneCostoValido(){
		...
		Edificador unEdificador = new Edificador();
		Unidad unaEstacionDeBomberos = unEdificador.construirEstacionDeBomberos();
	...
	public void testCentralEolicaTieneCostoValido(){
		...
		Edificador unEdificador = new Edificador();
		UnidadEnergetica unaCentralEolica = unEdificador.construirCentralEolica();
	...
	public void testCentralMineraTieneCostoValido(){
		...
		Edificador unEdificador = new Edificador();
		UnidadEnergetica unaCentralMinera = unEdificador.construirCentralMinera();
	...
	public void testCentralNuclearTieneCostoValido(){
		...
		Edificador unEdificador = new Edificador();
		UnidadEnergetica unaCentralNuclear = unEdificador.construirCentralNuclear();
	...
	//TODO faltan tests de reparaciones, ver como terminamos definiendo este tema
